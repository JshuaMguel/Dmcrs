<!DOCTYPE html><html><head><meta charset="utf-8"><title>Approvals Log PDF</title><style>body{font-family:DejaVu Sans,Arial,sans-serif;font-size:12px;color:#111}h1{font-size:20px;margin:0 0 10px}table{width:100%;border-collapse:collapse;margin-top:10px}th,td{border:1px solid #ccc;padding:6px;font-size:11px}th{background:#023047;color:#fff;text-align:left}tr:nth-child(even){background:#f7f9fc}.meta{margin-top:5px;font-size:11px;color:#555}.badge{display:inline-block;padding:2px 6px;border-radius:4px;font-size:10px;font-weight:600}.approved{background:#d1fae5;color:#065f46}.rejected{background:#fee2e2;color:#991b1b}.recommended{background:#fef3c7;color:#92400e}.pending{background:#e0e7ff;color:#3730a3}</style></head><body>
...
@php
    ...
    $decisionClass = strtolower($approval->decision);
@endphp
<tr>
