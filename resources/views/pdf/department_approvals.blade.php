...
<head>
    <meta charset="utf-8">
    <title>Approvals Log PDF | USTP DMCRS</title>
    <style>
        body {
...
<body>
    ...
    <div class="meta-info">
        <div class="meta-item"><strong>Report:</strong> Department Approvals Log</div>
        ...
        <div class="meta-item"><strong>Total Approvals:</strong> {{ $approvals->count() }}</div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ Str::limit($approval->remarks ?: '—', 25) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
