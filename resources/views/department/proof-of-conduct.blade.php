...
<div class="max-w-7xl mx-auto bg-white p-4 sm:p-6 rounded-xl shadow-lg">
        ...
        <div>
            <div class="flex items-center mb-2">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm sm:text-base">View proof images uploaded by faculty members</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 sm:p-6 mb-6">
        ...
        <p class="text-sm sm:text-base text-gray-700">
            This page shows all proof of conduct images uploaded by faculty members from your department. 
