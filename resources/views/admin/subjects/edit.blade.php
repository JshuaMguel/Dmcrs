...
@section('title', 'Edit Subject - USTP DMCRS')
...
<div class="max-w-3xl mx-auto bg-white p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg border border-gray-100">
    ...
    <div class="text-center mb-6 sm:mb-8">
        ...
        <h2 class="text-2xl sm:text-3xl font-bold text-ustpBlue mb-2">Edit Subject</h2>
        <p class="text-gray-600 text-sm sm:text-base">Update subject information</p>
    </div>
