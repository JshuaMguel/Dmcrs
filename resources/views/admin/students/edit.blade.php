...
@section('title', 'Edit Student - USTP DMCRS')
...
<div class="max-w-3xl mx-auto bg-white p-4 sm:p-6 lg:p-8 rounded-xl shadow-lg border border-gray-100">
    ...
    <div class="text-center mb-6 sm:mb-8">
        ...
        <h2 class="text-2xl sm:text-3xl font-bold text-ustpBlue mb-2">Edit Student</h2>
        <p class="text-gray-600 text-sm sm:text-base">Update student information</p>
    </div>

    <form action="{{ route('admin.students.update', $student) }}" method="POST" class="space-y-4 sm:space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-gray-50 p-4 sm:p-6 rounded-lg border border-gray-200">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div>
                    ...
                    <input type="text" name="student_id_number" value="{{ old('student_id_number', $student->student_id_number) }}"
