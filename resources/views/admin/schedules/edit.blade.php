...
@section('title', 'Edit Schedule - USTP DMCRS')
                    ...
                    <form method="POST" action="{{ route('admin.schedules.update', $schedule->id) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="subject_code" id="subject_code" value="{{ old('subject_code', $schedule->subject_code) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="subject_title" id="subject_title" value="{{ old('subject_title', $schedule->subject_title) }}" required
                                ...
                                <select name="section" id="section" required
                                    ...
                                    @foreach($sections as $section)
                                        <option value="{{ $section->abbreviated_name }}" 
                                                ...
                                                {{ (old('section', $schedule->section) == $section->abbreviated_name) ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="time" name="time_start" id="time_start" value="{{ old('time_start', $schedule->time_start) }}" required
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="time" name="time_end" id="time_end" value="{{ old('time_end', $schedule->time_end) }}" required
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="room" id="room" required
                                    ...
                                    @foreach($rooms as $room)
                                        <option value="{{ $room->name }}" {{ (old('room', $schedule->room) == $room->name) ? 'selected' : '' }}>
                                            {{ $room->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="semester" id="semester" value="{{ old('semester', $schedule->semester) }}"
    ...
    <script>
        ...
        if (departmentSelect && sectionSelect) {
            departmentSelect.addEventListener('change', function() {
                ...
                // Reset section dropdown if department changed
                if (selectedDepartment !== '{{ old("department_id", $schedule->department_id) }}') {
                    sectionSelect.value = '';
                }
