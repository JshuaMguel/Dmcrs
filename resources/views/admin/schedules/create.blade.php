                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type" required
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <option value="REGULAR" {{ old('type', 'REGULAR') == 'REGULAR' ? 'selected' : '' }}>Regular Class</option>
                                    <option value="MAKEUP" {{ old('type') == 'MAKEUP' ? 'selected' : '' }}>Makeup Class</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="lecture_type" id="lecture_type"
                                    ...
                                    <option value="LEC" {{ old('lecture_type') == 'LEC' ? 'selected' : '' }}>LEC</option>
                                    <option value="LAB" {{ old('lecture_type') == 'LAB' ? 'selected' : '' }}>LAB</option>
                                    <option value="LEC & LAB" {{ old('lecture_type') == 'LEC & LAB' ? 'selected' : '' }}>LEC & LAB</option>
                                </select>
                            </div>
