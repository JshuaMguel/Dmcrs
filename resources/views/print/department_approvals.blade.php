...
<head>
    ...
    <title>Approvals Log - Print | USTP DMCRS</title>
    <style>
        @media print {
...
<body>
    <div class="no-print">
        ...
        <a href="{{ route('department.approvals') }}" class="btn btn-back">← Back</a>
    </div>
    ...
    <div class="meta-info">
        <div class="meta-item">
            <strong>📋 Report:</strong> Department Approvals Log
        </div>
        <div class="meta-item">
        ...
        <div class="meta-item">
            <strong>📊 Total Approvals:</strong> {{ $approvals->count() }}
        </div>
    </div>
    ...
    @php
        ...
        $recommendedCount = $approvals->where('decision', 'recommended')->count();
    @endphp

    <div class="stats-grid">
        <div class="stat-card">
            <div class="stat-label">Total Decisions</div>
            <div class="stat-value">{{ $approvals->count() }}</div>
        </div>
        <div class="stat-card">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value" style="color: #92400e;">{{ $recommendedCount }}</div>
        </div>
        <div class="stat-card">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $approval->created_at ? \Carbon\Carbon::parse($approval->created_at)->format('M d, Y g:i A') : '—' }}</td>
                <td>{{ Str::limit($approval->remarks ?: '—', 30) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
