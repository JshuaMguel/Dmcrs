    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-ustpBlue text-white p-6 shadow-lg transform -translate-x-full transition-transform duration-200 ease-in-out lg:translate-x-0"
        ...
        @elseif($role === 'academic_head')
            ...
            <ul class="space-y-3">
                ...
                <li><a href="{{ route('head.proof-of-conduct') }}" class="block bg-white text-ustpBlack hover:bg-ustpGold hover:text-ustpBlack p-2 rounded shadow {{ request()->routeIs('head.proof-of-conduct') ? 'bg-ustpGold text-ustpBlack font-bold' : '' }}">📸 Proof of Conduct</a></li>
